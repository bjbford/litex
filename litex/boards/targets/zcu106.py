...
from litex.boards.platforms import zcu106

from litex.soc.cores.clock import *
from litex.soc.integration.soc_core import mem_decoder, SoCCore
...
def main():
    parser = argparse.ArgumentParser(description="LiteX SoC port to ZCU106")
    builder_args(parser)
    args = parser.parse_args()

    soc = BaseSoC(platform=zcu106.Platform())
